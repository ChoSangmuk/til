...
- HTML파일을 자원으로서 다루게끔 src 폴더로 이동하고 직접 삽입한 Bundle을 삭제,
  - [index.html](PracticeSource/Webpack/usingPlugin/src/index.html), [about.html](PracticeSource/Webpack/usingPlugin/src/about.html)
...
- [webpack.config.js](PracticeSource/Webpack/usingPlugin/webpack.config.js)에 Plugin을 load(require)하고 실행
  - plugins 배열 속성에 Plugin 객체 생성자 실행, 생성자 파라미터의 옵션 확인
